...
public class Loop_ShoppingList {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (shoppingListReport.charAt(shoppingListReport.length()-1)==','){
                shoppingListReport=shoppingListReport.replace(shoppingListReport.substring(shoppingListReport.length()-1 ),"");
            }
            count++;
            totalPrice += price;
        ...
        System.out.println(
                  shoppingListReport.substring(0, shoppingListReport.length() - 2)
