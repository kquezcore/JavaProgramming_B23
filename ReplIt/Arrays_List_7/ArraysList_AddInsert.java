...
public class ArraysList_AddInsert {
...
we want to add),
this time, we will be giving it two parameters.
...
For example, if you had an ArrayList called nums
with the values (4,2,5,6), and you run the following:
