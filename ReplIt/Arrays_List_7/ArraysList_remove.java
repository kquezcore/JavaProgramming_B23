...
**Task**: Finish code so that it will remove the first two elements in
the given ArrayList of Integers (be careful, this is a little tricky!)
...
will result in (6,3,1,5), because after the first remove(3) is run, the
 2 and 5 get pushed up into the 3rd and 4th index, and then the second remove(3)
  will remove the 2, leaving the 5.
```
