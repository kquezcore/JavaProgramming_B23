...
public class Grade {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i <= grades.length-1; i++) {// i:0, 1, 2
            ...
            //  Variables_1.grades[i] = (scores[i] >= 90)?'A' :(scores[i] >= 80)?'B' :(scores[i] >= 70)?'C':(scores[i] >=60)?'D':'F';
...
2. given the following arrays:
         ...
         int [] scores = {90, 75, 80};
         char [] Variables_1.grades = new char[names.length];
         write a program that can store the gardes of the students in the array named Variables_1.grades
 */
